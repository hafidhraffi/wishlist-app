    ...
    return ListView(
      ...
      children: [
        FutureBuilder<List<Map<String, dynamic>>>(
            future: DbWLApp().getCheckedListsByUserId(1),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            //     image: DecorationImage(
            //         image: list[index]['picdata'] != null
            //             ? MemoryImage(list[index]['picdata'])llllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllllll
            //             : MemoryImage(Uint8List(0)),
            //         fit: BoxFit.cover),
            //   ),
            // ),
